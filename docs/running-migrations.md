...
to find setup problems before AI calls. See the [quickstart](../README.md#quickstart).
...
[output-evidence guide](output-evidence.md) for comparison coverage.
...
and review the [privacy details](model-privacy.md)
